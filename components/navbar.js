...
const Navbar = props => {
    ...
    return (
        <Box position="fixed" as="nav" w="100%" bg={useColorModeValue('#ffffff40', '#20202380')} style={{backdropFilter:'blue(10px'}} zIndex={1} {...props}>
                    ...
                    <Box ml={2} display={{base: 'inline-block', md: 'none'}}>
                        <Menu>
                            ...
                            <MenuList>
                                ...
                                <NextLink href="/" passHref>
                                    <MenuItem as={Link} href="https://www.github.com/aaronauld">View Source</MenuItem>
                                </NextLink>
                            </MenuList>
                        </Menu>
                    </Box>
